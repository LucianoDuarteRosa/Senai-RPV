/* Utilizando os conceitos de Orientação a Objetos: 
    ...
    class Fornecedor extends Endereco{
      ...
      constructor(logradouro, numero, bairro, cep, estado, nome, sobrenome, cnpj, sexo, dataNascimento, telefone ) {
          super(logradouro, numero, bairro, cep, estado);
          this.nome = nome;
    ...
    function validarEnviar(){
      ...
      try{
        ...
        let fornecedor = new Fornecedor(logradouro, numero, bairro, cep, estado, nome, sobrenome, cnpj, sexo, dataNasc, telefone);
